...
class ServicePassport {
    ...
    fun new(
        ...
        bind.apply {
            txtHeader.text = "Служебный паспорт"
            ...
            txtInfo9.text = "Дата окончания срока:"
        }
        ...
        bind.imgSaveBtn.setOnClickListener {
            ForDoc().clickSave(actionType, list, currentDoc, viewModel, bind,
                10, ico = R.drawable.fd_docks_service_passp, R.drawable.gradient_doc_blue, "main",
