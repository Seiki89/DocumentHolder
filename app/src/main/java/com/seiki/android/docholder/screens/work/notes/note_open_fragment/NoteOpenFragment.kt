...
class NoteOpenFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        bind.imgBtnDel.setOnClickListener { delNote(viewModel) }

        bind.imgBtnShareN.setOnClickListener { shareNote() }
    ...
    private fun delNote(viewModel: NoteOpenViewModel) {
        //удалить заметку
        viewModel.delete(currentNote) {}
        APP.navController.navigate(R.id.action_noteOpenFragment_to_noteFragment)
    }

    private fun saveAndExit(viewModel: NoteOpenViewModel) {
